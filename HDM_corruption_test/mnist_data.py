...
def get_hmd_data(test_id=0, dataset_dir='HDM_data/'):
    ...
    return train_total_data, train_size, validation_data, y_train, test_data, test_labels, x_test ##33333, x_test



if __name__ == "__main__":
    print("get_GENE_data")
    #print(get_gene_final2aug(14))
    a, b, _, _, c, d = get_GENE_data(14)
    print("train_total_data img label ", a.shape, b, c.shape,d.shape)
    print("---"*20)
